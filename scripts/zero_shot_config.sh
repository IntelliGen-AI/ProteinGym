...
export DMS_data_folder_subs="/root/data/DMS_ProteinGym_substitutions"
...
export DMS_output_score_folder_subs=../../output_scores/
...
export DMS_merged_score_folder_subs=../../merged_score/
